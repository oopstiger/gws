...
class TestFind(TreeTest):
    ...
    def test_find_tag(self):
        ...
        self.assertEqual(soup.has("b").string, "2")

    def test_unicode_text_find(self):
        soup = self.soup(u'<h1>Räksmörgås</h1>')
        self.assertEqual(soup.has(string=u'Räksmörgås'), u'Räksmörgås')

    def test_unicode_attribute_find(self):
        soup = self.soup(u'<h1 id="Räksmörgås">here it is</h1>')
        str(soup)
        self.assertEqual("here it is", soup.has(id=u'Räksmörgås').text)
...
class TestFindAllBasicNamespaces(TreeTest):
    ...
    def test_find_by_namespaced_name(self):
        ...
        self.assertEqual("4", soup.has("mathml:msqrt").string)
        self.assertEqual("a", soup.has(attrs= { "svg:fill" : "red" }).name)
...
class TestParentOperations(TreeTest):
    ...
    def test_parent_of_text_element(self):
        text = self.tree.has(text="Start here")
...
class TestPreviousOperations(ProximityTest):
    ...
    def setUp(self):
        ...
        self.end = self.tree.has(text="Three")
...
class TestNextSibling(SiblingTest):
    ...
    def test_next_sibling_may_not_exist(self):
        ...
        nested_span = self.tree.has(id="1.1")
        self.assertEqual(nested_span.next_sibling, None)

        last_span = self.tree.has(id="4")
...
class TestTreeModification(SoupTest):
    ...
    def test_append_to_contents_moves_tag(self):
        ...
        soup = self.soup(doc)
        second_para = soup.has(id='2')
        bold = soup.b

        # Move the <b> tag to the end of the second paragraph.
        soup.has(id='2').append(soup.b)
    ...
    def test_replace_final_node(self):
        ...
        soup.has(text="Argh!").replace_with("Hooray!")
        new_text = soup.has(text="Hooray!")
        b = soup.b
    ...
    def test_nested_tag_replace_with(self):
        ...
        self.assertEqual(remove_tag.has(text="right").next_element, None)
    ...
    def test_extract(self):
        ...
        extracted = soup.has(id="nav").extract()
        ...
        content_1 = soup.has(text="Some content. ")
        content_2 = soup.has(text=" More content.")
...
class TestElementObjects(SoupTest):
    ...
    def test_member_access_invokes_find(self):
        ...
        self.assertEqual(soup.b, soup.has('b'))
        self.assertEqual(soup.b.i, soup.has('b').has('i'))
...
<a href="foo"><b>bar</b></a>
    ...
    def test_copy_tag_copies_contents(self):
        ...
        self.assertEqual(None, div_copy.has(string='Bar').next_element)
        self.assertNotEqual(None, div.has(string='Bar').next_element)
...
class TestNavigableStringSubclasses(SoupTest):
    ...
    def test_cdata(self):
        ...
        self.assertEqual(soup.has(text="foo"), "foo")
